...
func parseEditFlags(args []string) (editFlags, string, error) {
	...
	fs.StringVar(&f.description, "d", "", "new description (plain text; line breaks preserved)")
	fs.StringVar(&f.description, "description", "", "new description (plain text; line breaks preserved)")
